...
#include "libstoch/regression/LocalLinearRegression.h"
#include "libstoch/regression/LocalConstRegression.h"
#include "libstoch/regression/LocalSameSizeLinearRegression.h"
#include "libstoch/regression/LocalSameSizeConstRegression.h"
#include "libstoch/regression/LocalGridKernelRegression.h"
#include "libstoch/core/utils/Polynomials1D.h"
#include "libstoch/regression/GlobalRegression.h"
...
void testAmericanSameSizeLocal(const int &p_nDim, const int &p_nbSimul, const int &p_nMesh, const double &p_referenceValue, const double &p_accuracyEqual)
{
    ...
    BasketPut payoff(strike);
    // create the meshing
    double xmin = simulator.getParticles().minCoeff() - libstoch::tiny;
    double xmax = simulator.getParticles().maxCoeff() + libstoch::tiny;
    // mesh

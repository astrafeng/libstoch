...
int main(int argc, char *argv[])
{
    ...
    for (int isw = 0; isw < nbSwitch.size(); ++isw)
    {
        ...
        for (int ipart = 0; ipart < nbpart; ++ipart)
        {
            ...
            std::tuple< double, Eigen::Array<double, 6, 1>, double,  Eigen::Array<double, 6, 1> >    val = libstoch::solvePDEDYMCConst<6, libstoch::ExpDist, trng::mrg4>(mu, vol, volInv, fNonLin, point, 0., mat, law,  g, nbSim, gen);

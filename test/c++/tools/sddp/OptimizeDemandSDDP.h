...
#include "libstoch/sddp/SDDPCutBase.h"
...
class OptimizeDemandSDDP : public libstoch::OptimizerSDDPBase
{
...
private :
                          ...
                          double &p_stateFollowing, double &p_cost) const
    {
        ...
        // for demand
        lowBound(0) = 0 ;
        upperBound(0) = libstoch::infty;
        // for  fictitious data for bellman
        lowBound(1) = - libstoch::infty;
        upperBound(1) = libstoch::infty;
        ...
        for (int icut = 0 ; icut < cuts.cols(); ++icut)
        {
            ...
            upperBoundConst(icut + 1) = libstoch::infty ;
        }
        //  model
        ClpSimplex  model;

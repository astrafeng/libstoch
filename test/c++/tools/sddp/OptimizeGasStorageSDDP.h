...
protected:
    ...
    virtual inline 	 Eigen::ArrayXXd calCuts(const libstoch::SDDPCutOptBase &p_linCut) const
    {
...
public:
                        ...
                        Eigen::ArrayXd    &p_lowBoundConst,  Eigen::ArrayXd   &p_upperBoundConst) const
    {
        ...
        for (int icut = 0 ; icut < cuts.cols() ; ++icut)
        {
            ...
            p_lowBoundConst(ibound + icut) = - libstoch::infty;
...
class OptimizeGasStorageSDDP : public libstoch::OptimizerSDDPBase
{
private :
    ...
    void createAndSolveLP(const libstoch::SDDPCutOptBase   &p_linCut, const Eigen::ArrayXd &p_stockLevel,
                          ...
                          Eigen::ArrayXd &p_stateFollowing, double &p_gain) const
    {
        ...
        lowBound(3 * m_nbStorage) = - libstoch::infty;
...
public :
    ...
    double  oneStepForward(const Eigen::ArrayXd &p_aParticle, Eigen::ArrayXd &p_state, Eigen::ArrayXd &p_stateToStore,
                           const libstoch::SDDPCutOptBase &p_linCut, const int &) const
    {

...
#include "libstoch/semilagrangien/SimulateStepSemilagrangControl.h"

using namespace std;

double semiLagrangianSimuControl(const shared_ptr<libstoch::SpaceGrid> &p_grid,
                                ...
                                )
{
    ...
    for (int istep = 0; istep < p_nbStep; ++istep)
    {
        ...
        libstoch::SimulateStepSemilagrangControl(ar, p_nbStep - 1 - istep, nameAr, p_grid, p_grid, p_optimize
#ifdef USE_MPI
                                              , p_world
#endif

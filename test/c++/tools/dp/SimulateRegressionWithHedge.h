...
Eigen::Array4d  SimulateRegressionWithHedge(const std::shared_ptr<libstoch::SpaceGrid> &p_grid,
                                           ...
                                           )
{
    ...
    {
        libstoch::SimulateStepRegression(ar, nbStep - 1 - istep, nameAr, p_grid, p_optimize
#ifdef USE_MPI
                                      , p_world
#endif

...
class OptimizeThermalAsset : public libstoch::OptimizerSwitchBase
{
private :
...
public:
    ...
    ///              .
    virtual Eigen::ArrayXd    stepOptimize(const   std::vector<std::shared_ptr< libstoch::RegularSpaceIntGrid>>  &p_grid,
                                           const   int &p_iReg,
                                           const   Eigen::ArrayXi  &p_state,
                                           const   std::shared_ptr< libstoch::BaseRegression>  &p_condExp,
    ...
    virtual void stepSimulate(const std::vector<std::shared_ptr< libstoch::RegularSpaceIntGrid> >  &p_grid,
                              const std::shared_ptr< libstoch::BaseRegression>  &p_condExp,
                              const std::vector< Eigen::ArrayXXd >   &p_basisFunc,
                              libstoch::StateWithIntState &p_state,
    ...
    std::shared_ptr< libstoch::SimulatorDPBase > getSimulator() const
    {
        return m_simulator ;
    }

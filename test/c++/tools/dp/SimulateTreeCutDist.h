...
#include "libstoch/dp/SimulateStepTreeCutDist.h"
...
double SimulateTreeCutDist(const std::shared_ptr<libstoch::FullGrid> &p_grid,
                           const std::shared_ptr<libstoch::OptimizerDPCutTreeBase > &p_optimize,
                           ...
                           const boost::mpi::communicator &p_world)
{
    ...
    {
        libstoch::SimulateStepTreeCutDist(ar, nbStep - 1 - istep, nameAr, p_grid, p_optimize, p_bOneFile, p_world).oneStep(states, costFunction);

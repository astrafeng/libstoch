...
class OptimizeDPEmissive: public libstoch::OptimizerDPBase
{
...
public :
    ...
    virtual void stepSimulate(const std::shared_ptr< libstoch::SpaceGrid>   &p_grid, const std::vector< libstoch::GridAndRegressedValue > &p_continuation,
    ...
    void stepSimulateControl(const std::shared_ptr< libstoch::SpaceGrid> &, const std::vector< libstoch::GridAndRegressedValue  > &,
                             libstoch::StateWithStocks &, Eigen::Ref<Eigen::ArrayXd>) const {}
    ...
    virtual std::shared_ptr< libstoch::SimulatorDPBase > getSimulator() const
    {
        return m_simulator;
    }

        ...
        const boost::mpi::communicator &p_world)
{
    ...
    for (int istep = 0; istep < nbStep; ++istep)
    {
        ...
        while (libstoch::isStrictlyLesser(nextTime, p_timeChangeGrid[iTimeNext]))
            iTimeNext--;
        int iTime = iTimeNext;
        while (libstoch::isStrictlyLesser(currTime, p_timeChangeGrid[iTime]))
            iTime--;
        ...
        libstoch::SimulateStepMultiStageRegressionDist(ar, nbStep - 1 - istep, nameAr, toStorBellDet,

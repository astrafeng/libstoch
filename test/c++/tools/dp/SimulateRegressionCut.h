...
double SimulateRegressionCut(const std::shared_ptr<libstoch::FullGrid> &p_grid,
                            ...
                            )
{
    ...
    {
        libstoch::SimulateStepRegressionCut(ar, nbStep - 1 - istep, nameAr, p_grid, p_optimize
#ifdef USE_MPI
                                         , p_world
#endif

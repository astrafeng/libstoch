...
#include "libstoch/dp/SimulateStepMultiStageRegressionDist.h"
...
double SimulateMultiStageRegressionDist(const std::shared_ptr<libstoch::FullGrid> &p_grid,
                                        ...
                                        const boost::mpi::communicator &p_world)
{
    ...
    for (int istep = 0; istep < nbStep; ++istep)
    {
        ...
        libstoch::SimulateStepMultiStageRegressionDist(ar, nbStep - 1 - istep, nameAr, toStorBellDet, p_grid, p_grid, p_optimize, p_bOneFile, p_world).oneStep(states, costFunctionPeriod);

...
///
double  DynamicProgrammingSwitchingByRegressionDist(const std::vector< std::shared_ptr<libstoch::RegularSpaceIntGrid> >  &p_grid,
        const std::shared_ptr<libstoch::OptimizerSwitchBase > &p_optimize,

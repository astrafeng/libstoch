...
class BlackScholesSimulator : public libstoch::SimulatorDPBase
{
private :
    ...
    {
        if (libstoch::almostEqual(m_currentStep, libstoch::zero, libstoch::ulp))
            m_brownian.setConstant(libstoch::zero);
        else
        {

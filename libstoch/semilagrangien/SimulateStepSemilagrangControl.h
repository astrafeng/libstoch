...
#include "libstoch/semilagrangien/SimulateStepSemilagrangBase.h"
...
private :
    ...
    std::shared_ptr<libstoch::OptimizerSLBase >  m_pOptimize ; ///< optimizer solving the problem for one point and one step
#ifdef USE_MPI

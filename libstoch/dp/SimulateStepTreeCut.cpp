...
#include "libstoch/dp/SimulateStepTreeCut.h"
#ifdef USE_MPI
#include <boost/mpi.hpp>
#include <boost/mpi/collectives.hpp>
#include "libstoch/core/parallelism/all_gatherv.hpp"
#endif
#include "libstoch/tree/ContinuationCutsTreeGeners.h"
...
SimulateStepTreeCut::SimulateStepTreeCut(gs::BinaryFileArchive &p_ar,  const int &p_iStep,  const string &p_nameCont,
        const   shared_ptr<SpaceGrid> &p_pGridFollowing, const  shared_ptr<libstoch::OptimizerDPCutTreeBase > &p_pOptimize
#ifdef USE_MPI

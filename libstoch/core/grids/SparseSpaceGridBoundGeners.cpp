...
#include "libstoch/core/grids/SparseOrderTinyVectorGeners.h"
...
SparseSpaceGridBound *SparseSpaceGridBoundGeners::read(const gs::ClassId &p_id, istream &p_in) const
{
    ...
    // Return the object
    return new libstoch::SparseSpaceGridBound(*lowValues, *sizeDomain, levelMax, *weight, dataSet, nbPoints, degree, son, neighbourBound, iBase);
}

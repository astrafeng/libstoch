...
struct RegularSpaceGridDerivedGeners: public gs::AbsReaderWriter<libstoch::FullGrid>
{
...
gs_associate_serialization_factory(libstoch::RegularSpaceGrid, StaticSerializationFactoryForFullGrid)
